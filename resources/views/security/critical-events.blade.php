                    ...
                    <div class="card border-0 shadow-sm border-start border-danger border-5">
                        <div class="card-body">
                            <h5 class="card-title text-danger mb-3">
                                <i class="bi bi-exclamation-triangle me-2"></i>Top IP Addresses dengan Failed Attempts (7
                                hari terakhir)
                            </h5>
                                    ...
                                    <tbody>
                                        @foreach ($topFailedIPs as $index => $ipData)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-danger">{{ $ipData->attempt_count }}
                                                        attempts</span>
                                                </td>
                                                <td>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="event_type" class="form-select" onchange="this.form.submit()">
                                    ...
                                    <option value="failed_login"
                                        {{ request('event_type') === 'failed_login' ? 'selected' : '' }}>Failed Login
                                    </option>
                                    <option value="unauthorized_access"
                                        {{ request('event_type') === 'unauthorized_access' ? 'selected' : '' }}>
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($criticalEvents as $event)
                                        <tr class="align-middle">
                                            <td>
                                                <span
                                                    class="badge bg-light text-dark">{{ $event->created_at->format('d M Y') }}</span><br>
                                                <small
                                                    class="text-muted">{{ $event->created_at->format('H:i:s') }}</small>
                                            </td>
                                            <td>
                                                ...
                                                @else
                                                    <span
                                                        class="badge bg-secondary">{{ ucfirst($event->event_type) }}</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <code
                                                    class="bg-light p-1 rounded text-danger">{{ $event->ip_address }}</code>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="detailModal{{ $event->id }}"
                                                    tabindex="-1">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content border-danger border-3">
                                                            <div class="modal-header bg-danger text-white">
                                                                <h5 class="modal-title">
                                                                    <i class="bi bi-exclamation-triangle me-2"></i>Event
                                                                    Details
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row mb-3">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        {{ ucfirst($event->event_type) }}<br>
                                                                        <strong>Severity:</strong>
                                                                        {{ ucfirst($event->severity) }}<br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        {{ $event->ip_address }}<br>
                                                                        <strong>Waktu:</strong>
                                                                        {{ $event->created_at->format('d M Y H:i:s') }}<br>
                                                                        <strong>Resource:</strong>
                                                                        {{ $event->resource_type }} (ID:
                                                                        {{ $event->resource_id }})
                                                                    </div>
                                                                </div>
                                                                ...
                                                                @if ($event->user_agent)
                                                                    ...
                                                                    <small
                                                                        class="text-muted d-block">{{ $event->user_agent }}</small>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="mt-4 d-flex justify-content-between align-items-center">
                            <div class="text-muted">
                                Menampilkan <strong>{{ $criticalEvents->count() }}</strong> dari
                                <strong>{{ $criticalEvents->total() }}</strong> events
                            </div>
                            <div>
